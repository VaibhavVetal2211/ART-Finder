    ...
    const fetchEntertainmentNews = async () => {
      try {
        const response = await axios.get('https://newsapi.org/v2/everything', {
          params: {
            domains: 'indiewire.com,timesofindia.com',
            apiKey: '8387d2b7051240a7abaceda5d0c5dd56',
            pageSize: 12,
            language: 'en',
            sortBy: 'publishedAt',
            q: 'entertainment OR hollywood OR bollywood OR movies OR cinema'
          }
        })
    ...
    <Box sx={{ 
      ...
      <Container maxWidth="lg" sx={{ py: { xs: 8, md: 12 }, flex: 1 }}>
        ...
        <Typography variant="h5" sx={{ mb: 6, color: '#666' }}>
          Latest entertainment news from Hollywood and Bollywood
        </Typography>
